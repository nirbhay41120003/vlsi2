...
module sigmoid_lut_q15 (
    input  signed [31:0] x_q15,  // Q1.15 (32-bit signed)
    ...
    // x is Q1.15. Map: idx = round( (x + 8) * (LUT_SIZE-1) / 16 )
    wire signed [31:0] x_plus_8_q15 = x_q15 + (8 <<< 15);
    // numerator = x_plus_8_q15 * (LUT_SIZE-1)
    wire signed [47:0] numerator = x_plus_8_q15 * (LUT_SIZE-1);
    // denominator = 16 in Q0, but since x_plus_8_q15 is Q1.15, divide by 16*2^15 => shift right by (4 + 15) = 19
    wire signed [47:0] idx_w = numerator >>> 19; // safe shift
